...
### Features:
* **High-Frequency Sampling:** Analyzes 100+ data points per city.
* **Volatility Index:** Calculates weather stability using Standard Deviation.
* **CI/CD Integrated:** Automated runs on every code change.